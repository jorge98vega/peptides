...
# Ejemplo de cómo usar el script - windows de 1 a 49, empezando por la 25:
# ./run_all_wham.sh 4t8sXwL_run40w 25 49 0

INPUT=$1  # Archivo de entrada (por ejemplo, archivo .top de Amber)
window=$2  # Número de ventana actual
limit=$3  # Límite de ventanas (última ventana a procesar)
step=$4  # Paso actual
OLD_JOB_ID=$5  # ID del trabajo anterior (para establecer dependencias de ejecución)
